    ...
    return (
      <footer className="foo">
        ...
        <div className="foo__links">
          ...
          <div>
            <a className="foo__link" href="https://go.microsoft.com/fwlink/?LinkId=521839" target="_blank" rel="noopener noreferrer">Privacy &amp; Cookies</a>
            <a className="foo__link" href="https://go.microsoft.com/fwlink/?LinkID=206977" target="_blank" rel="noopener noreferrer">Terms of use</a>
            <a className="foo__link" href="https://www.microsoft.com/trademarks" target="_blank" rel="noopener noreferrer">Trademarks</a>
            <a className="foo__link" href="https://support.microsoft.com/en-us/contactus" target="_blank" rel="noopener noreferrer">Report abuse</a>
