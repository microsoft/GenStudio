...
export default class SelectPage extends Component {
    ...
    componentDidMount(){
        ...
        this.objIDsToImages([116884, 79226, 39597, 70467, 156867, 116963, 22270, 22408, 23143, 25114, 35652, 201671, 202194, 232038, 324830, 324917, 544501, 751402, 337493, 453183, 770740, 45647]);
    }
